...
export default function Recibos() {
  ...
  const descargarPdf = async (id) => {
    const res = await axios.get(
      `http://localhost:8080/api/recibos/${id}/pdf`,
      {
        responseType: "blob",
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Recibo generado", {
        description: "El recibo fue generado y descargado correctamente",
      })
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={habitacionId} onValueChange={handleHabitacionChange}>
                <SelectTrigger className="bg-zinc-950 border-zinc-800">
            ...
            <div className="space-y-2">
              ...
              <Select value={estado} onValueChange={setEstado}>
                ...
                <SelectContent className="bg-zinc-950 border-zinc-800">
                  <SelectItem value="PUNTUAL" className="text-white hover:bg-zinc-600">
                    Pago puntual
                  </SelectItem>
                  <SelectItem value="TARDIO" className="text-white hover:bg-zinc-600">
                    Pago con demora
                  </SelectItem>
                </SelectContent>
              </Select>
